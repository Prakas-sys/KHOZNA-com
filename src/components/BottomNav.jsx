...
const BottomNav = ({ currentView, onNavigate, onPostProperty }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
            <div className="bg-white rounded-t-[30px] shadow-[0_-5px_20px_rgba(0,0,0,0.06)] px-6 py-2 pointer-events-auto pb-safe h-[80px]">
                    ...
                    {navItems.map((item) => {
                        ...
                        if (item.type === 'special') {
                            return (
                                ...
                                >
                                    <div className="w-[72px] h-[72px] bg-[#00A8E8] rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform active:scale-95">
                        ...
                        // Handle Reels & Profile (Filled Circles)
                        if (item.type === 'filled-icon') {
                            return (
                                ...
                                >
                                    <div className={`w-[28px] h-[28px] rounded-full flex items-center justify-center transition-colors duration-200 ${isActive ? 'bg-[#00A8E8] shadow-md shadow-sky-200' : 'bg-gray-400'
                                        }`}>
                        ...
                        // Handle Explore & Message (PNG Images)
                        return (
                            <button
                                key={item.id}
                                onClick={() => onNavigate(item.id)}
